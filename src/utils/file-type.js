...
export const suffix = {
  ...
  cadFile: [
    '3DM','3DS','A','ASM','BRD','CATPART','CATPRODUCT','CGR','COLLABORATION','DAE',
    'DGN','DLV3','DWF','DWFX','DWG','DXF','EMODE','EXP','F2D','F3D',
    'FBX','G','GBXML','GLB','GLTF','IAM','IDW','IFC','IGE','IGES',
    'IGS','IPT','IWM','JT','MAX','MODEL','MPF','MSR','NEU','NWC',
    'NWD','OBJ','PAR','PMLPRJ','PMLPRJZ','PRT','PSM','PSMODEL','RVM',
    'RVT','SAB','SAT','SCH','SESSION','SKP','SLDASM','SLDDRW','SLDPRT','STE',
    'STEP','STL','STLA','STLB','STP','STPZ','VUE','WIRE','X_B','X_T',
    'XAS','XPR'
  ],
}

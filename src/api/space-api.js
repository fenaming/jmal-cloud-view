...
export default {
  // 上传
  simpleUploadURL: process.env.VUE_APP_BASE_API + '/space/upload',
  // 上传头像
  simpleUploadAvatarURL: process.env.VUE_APP_BASE_API + '/space/upload',
  // 合并
